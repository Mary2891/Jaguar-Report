...
public class Quejas  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt1=(EditText)findViewById(R.id.nom_queja);
        edt2=(EditText)findViewById(R.id.des_queja);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialogoFecha = new DatePickerDialog(Quejas.this, listenerDeDatePicker, ultimoAnio, ultimoMes, ultimoDiaDelMes);
                dialogoFecha.show();
            }
        });
    ...
    public void after_enviar (View view){
        ...
        Toast.makeText(this, "Tu queja se ha enviado", Toast.LENGTH_SHORT).show();
